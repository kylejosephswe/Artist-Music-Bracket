  ...
  return (
    ...
    <div className="inner-flex">
      ...
      {!songsArray[topCount]?.src ? (
            <h1>Your favorite Keshi song!</h1>
          ) : (
            <iframe
      ...
      <button className="top-button" type="button" onClick={revealTopSong}>
        ❤
      </button>
      }
    </div>
    <div className="inner-flex">
      ...
      <button className="bottom-button" type="button" onClick={revealBottomSong}>
        ❤
      </button>
}
    </div>
